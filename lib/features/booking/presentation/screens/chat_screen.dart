...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final List<Message> _messages = [
    Message(text: "Hi, is the car available for tomorrow?", isMe: true, time: "10:00 AM"),
    Message(text: "Yes, it is available. Would you like to book it?", isMe: false, time: "10:05 AM"),
  ];
  ...
  void _sendMessage() {
    if (_controller.text.isNotEmpty) {
      ...
      Future.delayed(const Duration(seconds: 1), () {
        if (mounted) {
          setState(() {
            _messages.add(Message(text: "Great! Let me know if you have any questions.", isMe: false, time: "Now"));
          });
        }
      });
    }
