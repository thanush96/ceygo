            ...
            children: [
              ...
              Text(
                ...
                style: theme.textTheme.headlineMedium?.copyWith(
                  ...
                  color: Colors.black, // Changed to white for better contrast on gradient
                ),
              ),
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(width: 1, color: Color(0xFF2563EB).withOpacity(0.3)),
                  boxShadow: [
                    BoxShadow(
                        ...
                        child: Row(
                          children: [
                            _buildRoleSelector(
                              ...
                              label: l10n.rider,
                              icon: Icons.person,
                              isSelected: _selectedRole.contains('Rider'),
                            ...
                            _buildRoleSelector(
                              ...
                              isSelected: _selectedRole.contains('Provider'),
